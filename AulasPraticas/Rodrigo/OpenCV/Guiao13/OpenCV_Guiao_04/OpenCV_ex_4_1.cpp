...
int main( int argc, char** argv )
{
    ...
    se11_11 = getStructuringElement(MORPH_ELLIPSE, Size(11,11));

    Mat imagemDilate;

    dilate(imagemBinary, imagemDilate, se11_11);
    dilate(imagemDilate, imagemDilate, se11_11);
    dilate(imagemDilate, imagemDilate, se11_11);
    dilate(imagemDilate, imagemDilate, se11_11);
    dilate(imagemDilate, imagemDilate, se11_11);
    dilate(imagemDilate, imagemDilate, se11_11);
    ...
    namedWindow( "Dilate Image", CV_WINDOW_AUTOSIZE );

    imshow( "Dilate Image", imagemDilate );
