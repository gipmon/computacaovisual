...
int main( int argc, char** argv )
{
    ...
    Mat se11_11;
    Mat se3_3;
    se11_11 = getStructuringElement(MORPH_RECT, Size(3,3));
    ...
    namedWindow( "Erode11", CV_WINDOW_AUTOSIZE );

    imshow( "Erode11", imagemErode11 );

    namedWindow( "Erode3", CV_WINDOW_AUTOSIZE );

    imshow( "Erode3", imagemErode3 );
