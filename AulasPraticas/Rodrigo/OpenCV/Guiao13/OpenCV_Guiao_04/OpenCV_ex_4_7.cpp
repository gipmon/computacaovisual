...
int main( int argc, char** argv )
{
    ...
    Mat se11_11;
    Mat se3_3;
    se11_11 = getStructuringElement(MORPH_RECT, Size(3,9));
    se3_3 = getStructuringElement(MORPH_RECT, Size(9,3));
    ...
    namedWindow( "Final3_9", CV_WINDOW_AUTOSIZE );

    imshow( "Final3_9", imagemFinal11 );

    namedWindow( "Final9_3", CV_WINDOW_AUTOSIZE );

    imshow( "Final9_3", imagemFinal3 );
