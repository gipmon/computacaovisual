...
int main( int argc, char** argv )
{
    ...
    namedWindow( "Subtract Dilate11", CV_WINDOW_AUTOSIZE );

    imshow( "Subtract Dilate11", imagemDilate11 );

    namedWindow( "Subtract Dilate3", CV_WINDOW_AUTOSIZE );

    imshow( "Subtract Dilate3", imagemDilate3 );
