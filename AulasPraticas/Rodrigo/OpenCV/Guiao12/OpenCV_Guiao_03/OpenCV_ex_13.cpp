...
int main( int argc, char** argv )
{
    ...
    // Filtro de Media 5 x 5
     Mat imagemFMedia5x5_1;

    blur( imagemOriginal, imagemFMedia5x5_1, Size( 5, 5) );

    namedWindow( "Filtro de Media 5 x 5 - 1 Iter", CV_WINDOW_AUTOSIZE );

    imshow( "Filtro de Media 5 x 5 - 1 Iter", imagemFMedia5x5_1 );
    // Filtro de Media 7 x 7
     Mat imagemFMedia7x7_1;

    blur( imagemOriginal, imagemFMedia7x7_1, Size( 7, 7) );

    namedWindow( "Filtro de Media 7 x 7 - 1 Iter", CV_WINDOW_AUTOSIZE );

    imshow( "Filtro de Media 7 x 7 - 1 Iter", imagemFMedia7x7_1 );
