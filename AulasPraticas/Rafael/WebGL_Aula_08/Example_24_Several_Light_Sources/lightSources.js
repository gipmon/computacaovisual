...
lightSources[0].setIntensity( 1.0, 0.0, 0.0, 0.0 );

lightSources[0].setAmbIntensity( 0.2, 0.0, 0.0, 0.0 );
...
lightSources[2].setPosition( 0.0, 0, 10.0, 1.0 );
...
lightSources[3].setPosition( 0, -10, 0, 1.0 );
